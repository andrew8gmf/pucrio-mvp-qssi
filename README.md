...
Este repositório contém o Produto Mínimo Viável (MVP) desenvolvido para a pós-graduação em Ciência de Dados e Analytics da PUC-Rio. O projeto implementa um sistema de software inteligente capaz de classificar níveis de depressão com base em traços de personalidade e indicadores demográficos, utilizando o conjunto de dados Depression Anxiety Stress Scales (DASS-42).
...
- Pytest (Testes automatizados de desempenho)

## Instruções de Operação

Para detalhes técnicos sobre a execução e configuração de cada módulo, consulte as documentações específicas:
